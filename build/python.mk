...
python-checkstyle: docker-python-images ## Python code style check
...
python-preproc-requirements: docker-python-images ## Run pip-compile for all requirements.in files
